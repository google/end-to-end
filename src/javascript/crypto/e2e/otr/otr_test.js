...
function testSerializeBytes() {
  e2e.otr.testing.assertTypedArrayEquals([1, 2, 3, 4],
...
function testConcat() {
  e2e.otr.testing.assertTypedArrayEquals([], e2e.otr.concat([]));
  e2e.otr.testing.assertTypedArrayEquals([1, 2, 3, 4, 5, 6], e2e.otr.concat([
    new Uint8Array([1, 2]),
    [3, 4],
    new Uint8Array([5]),
    [],
...
function testNumToByte() {
  e2e.otr.testing.assertTypedArrayEquals([0], e2e.otr.numToByte(0));
  e2e.otr.testing.assertTypedArrayEquals([0x56], e2e.otr.numToByte(0x56));
  e2e.otr.testing.assertTypedArrayEquals([0xFF], e2e.otr.numToByte(0xFF));
...
function testNumToShort() {
  e2e.otr.testing.assertTypedArrayEquals([0, 0], e2e.otr.numToShort(0));
  e2e.otr.testing.assertTypedArrayEquals([0x56, 0x78],
      e2e.otr.numToShort(0x5678));
  e2e.otr.testing.assertTypedArrayEquals([0xFF, 0xFF],
      e2e.otr.numToShort(0xFFFF));
...
function testNumToInt() {
  e2e.otr.testing.assertTypedArrayEquals([0, 0, 0, 0], e2e.otr.numToInt(0));
  e2e.otr.testing.assertTypedArrayEquals([0x12, 0x34, 0x56, 0x78],
      e2e.otr.numToInt(0x12345678));
  e2e.otr.testing.assertTypedArrayEquals([0xFF, 0xFF, 0xFF, 0xFF],
