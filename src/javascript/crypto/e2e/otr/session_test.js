...
function testConstructor() {
  ...
  e2e.otr.testing.assertTypedArrayEquals(tag, s.instanceTag);
  e2e.otr.testing.assertTypedArrayEquals([0, 0, 0, 0], s.remoteInstanceTag);
...
function testProcessMessage() {
  ...
  stubs.setPath('e2e.otr.message.handler.parse', function(session, receivedArg) {
    methodCalled = true;
