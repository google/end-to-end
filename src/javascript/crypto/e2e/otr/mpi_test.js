...
function testMpiConstructor() {
  ...
  e2e.otr.testing.assertTypedArrayEquals([0x01, 0x02, 0x03, 0xFF, 0xFE],
      new e2e.otr.Mpi(
...
function testMpiSerialize() {
  ...
  e2e.otr.testing.assertTypedArrayEquals([0, 0, 0, 0],
...
function testMpiParse() {
  e2e.otr.testing.assertTypedArrayEquals([0x01, 0x02, 0x03, 0xFF, 0xFE, 0xFF],
      Mpi.parse(new Uint8Array(
      [0, 0, 0, 0x06, 0x01, 0x02, 0x03, 0xFF, 0xFE, 0xFF])).data_);
  e2e.otr.testing.assertTypedArrayEquals([],
      Mpi.parse(new Uint8Array([0, 0, 0, 0])).data_);
  e2e.otr.testing.assertTypedArrayEquals(
  ...
  e2e.otr.testing.assertTypedArrayEquals([1, 2, 3], Mpi.parse(
