...
function testConstructor() {
  ...
  e2e.otr.testing.assertTypedArrayEquals(ta.iterable_, [1, 2, 3, 4, 5]);
...
function testNext() {
  ...
  e2e.otr.testing.assertTypedArrayEquals(ta.next(), [1]);
  e2e.otr.testing.assertTypedArrayEquals(ta.next(2), [2, 3]);
  e2e.otr.testing.assertTypedArrayEquals(ta.next(999), [4, 5]);
}
...
function testPeek() {
  ...
  e2e.otr.testing.assertTypedArrayEquals(ta.peek(), [1]);
  e2e.otr.testing.assertTypedArrayEquals(ta.peek(), [1]);
  e2e.otr.testing.assertTypedArrayEquals(ta.peek(3), [1, 2, 3]);
  e2e.otr.testing.assertTypedArrayEquals(ta.peek(6), [1, 2, 3, 4, 5]);
  e2e.otr.testing.assertTypedArrayEquals(ta.next(), [1]);
  e2e.otr.testing.assertTypedArrayEquals(ta.peek(), [2]);
}
...
function testRest() {
  ...
  e2e.otr.testing.assertTypedArrayEquals(ta.rest(), [1, 2, 3, 4, 5]);
  assertFalse(ta.hasNext());

  ta = new e2e.otr.util.Iterator(new Uint8Array([1, 2, 3, 4, 5]));
  e2e.otr.testing.assertTypedArrayEquals(ta.next(), [1]);
  e2e.otr.testing.assertTypedArrayEquals(ta.rest(), [2, 3, 4, 5]);
  assertFalse(ta.hasNext());
}
