...
e2e_build_templates() {
  ...
  find src -name '*.soy' -exec java -jar lib/closure-templates/SoyToJsSrcCompiler.jar \
...
e2e_build_extension() {
  ...
  SRC_DIRS=( src lib/closure-library lib/closure-templates $BUILD_TPL_DIR \
...
e2e_generate_jsdeps() {
  ...
  $PYTHON_CMD lib/closure-library/closure/bin/build/depswriter.py \
    ...
    --root_with_prefix="lib/closure-templates/ lib/closure-templates/" \
