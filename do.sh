...
case "$CMD" in
  ...
  deps)
    ...
    ;;
  *)
    echo "Usage: $0 {build_app|build_extension|build_library|build_library_ctx2|build_templates|build_docs|clean|check_deps|clean_deps|install_deps|testserver|test_compat_e2e|test_compat_bc|lint} [debug]"
    RETVAL=1
esac
