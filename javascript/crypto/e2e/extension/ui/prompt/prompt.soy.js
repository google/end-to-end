...
/**
 * @fileoverview Templates in namespace e2e.ext.ui.templates.prompt.
 */

goog.provide('e2e.ext.ui.templates.prompt');
goog.provide('e2e.ext.ui.templates.prompt.Main');
goog.provide('e2e.ext.ui.templates.prompt.RenderChip');
goog.provide('e2e.ext.ui.templates.prompt.RenderChipHolder');
goog.provide('e2e.ext.ui.templates.prompt.RenderEncrypt');
goog.provide('e2e.ext.ui.templates.prompt.RenderGenericForm');
goog.provide('e2e.ext.ui.templates.prompt.RenderMenu');
 ...
 */
e2e.ext.ui.templates.prompt.Main = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  e2e.ext.ui.templates.prompt.Main.soyTemplateName = 'e2e.ext.ui.templates.prompt.Main';
}
 ...
 * @suppress {checkTypes|uselessCode}
 */
e2e.ext.ui.templates.prompt.RenderMenu = function(opt_data, opt_ignored, opt_ijData) {
  var output = '<ul>';
...
if (goog.DEBUG) {
  e2e.ext.ui.templates.prompt.RenderMenu.soyTemplateName = 'e2e.ext.ui.templates.prompt.RenderMenu';
}
 ...
 * @suppress {checkTypes|uselessCode}
 */
e2e.ext.ui.templates.prompt.RenderEncrypt = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  e2e.ext.ui.templates.prompt.RenderEncrypt.soyTemplateName = 'e2e.ext.ui.templates.prompt.RenderEncrypt';
}
 ...
 * @suppress {checkTypes|uselessCode}
 */
e2e.ext.ui.templates.prompt.RenderGenericForm = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  e2e.ext.ui.templates.prompt.RenderGenericForm.soyTemplateName = 'e2e.ext.ui.templates.prompt.RenderGenericForm';
}
 ...
 * @suppress {checkTypes|uselessCode}
 */
e2e.ext.ui.templates.prompt.RenderChipHolder = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  e2e.ext.ui.templates.prompt.RenderChipHolder.soyTemplateName = 'e2e.ext.ui.templates.prompt.RenderChipHolder';
}
 ...
 * @suppress {checkTypes|uselessCode}
 */
e2e.ext.ui.templates.prompt.RenderChip = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  e2e.ext.ui.templates.prompt.RenderChip.soyTemplateName = 'e2e.ext.ui.templates.prompt.RenderChip';
}
