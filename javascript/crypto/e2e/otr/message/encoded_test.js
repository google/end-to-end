...
function testProcess() {
  ...
  stubs.setPath('otr.message.handler.process', function(session, type, data) {
    ...
    assertTypedArrayEquals(constants.MESSAGE_TYPE.DATA, type);
  ...
  var msg = process(fakeSession, constants.MESSAGE_PREFIX.ENCODED +
